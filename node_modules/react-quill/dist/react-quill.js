...
/***/ (function(module, exports) {
	...
	*/
	...
	var config = {
	  scope: _parchment2.default.Scope.INLINE,
	  whitelist: ['serif', 'monospace','nanumgothic','roboto','robotoblack']
	};
	...
	var FONTS = [false, 'serif', 'monospace','nanumgothic','roboto','robotoblack'];
	...
	var defaultItems = [
		...
		{ label:'Formats', type:'group', items: [
			{ label:'Font', type:'font', items: [
				...
				{ label:'Nanumgothic',   value:'nanumgothic' },
				{ label:'Roboto',   value:'roboto' },
				{ label:'Robotoblack',   value:'robotoblack' },
			]},
