...
var GridInline = exports.GridInline = function (_Component) {
  ...
  _createClass(GridInline, [{
    ...
    value: function doLayout(props) {
      return _exenv2.default.canUseDOM ? this.doLayoutForClient(props) : this.doLayoutForSSR(props);
    }
  }, {
    ...
    value: function doLayoutForClient(props) {
      ...
      var rects = childArray.map(function (child) {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['gutterWidth', 'gutterHeight', 'columnWidth', 'monitorImagesLoaded', 'enableSSR', 'refCallback', 'className', 'style', 'size', 'component', 'children']);
